...
from src.data_gen import noise_permutations_from_deformation, sample_errors, sample_error_batch
...
def test_sample_error_batch():
    ...
    # Act
    errors = sample_error_batch(key, batch_size, code, error_model, error_probability, noise_permutations)
    # Assert
...
if __name__ == "__main__":
    ...
    test_noise_permutations_from_deformation()
